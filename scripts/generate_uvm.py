...
dsim ^
    ...
    -top {module_name}_tbimport Dict, Any, List
import argparse
from datetime import datetime

class UVMGenerator:
    """Main UVM environment generator class."""
    ...
    def generate_package_file(self) -> bool:
        """Generate UVM package file including all components with updated paths."""
        try:
            module_name = self.config['dut']['module_name']
...
'''
    ...
    def generate_dsim_script(self) -> bool:
        """Generate DSIM simulation script following DSIMtuto best practices."""
        try:
            module_name = self.config['dut']['module_name']
...
// UVM package and components (organized directory structure)
...
'''
    ...
    def run(self) -> bool:
        ...
        print(f"To run simulation: cd {self.config['directories']['sim_exec']} && ./run_sim.sh")
        
        return True

def main():
    """Main function with command line argument parsing."""
    parser = argparse.ArgumentParser(description="UVM Base Generator")
